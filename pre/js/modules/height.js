...
function setChartHeight(iframe) {
    if(iframe == 'fixed') {
        ...
        document.getElementsByClassName('container')[0].style.height = '652px';
        document.getElementsByClassName('main')[0].style.height = '624px';
        ...
        let height = 624; //Altura total del main
