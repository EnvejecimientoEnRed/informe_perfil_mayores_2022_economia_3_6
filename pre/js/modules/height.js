...
function setChartHeight(iframe) {
    if(iframe == 'fixed') {
        ...
        document.getElementsByClassName('container')[0].style.height = '634px';
        document.getElementsByClassName('main')[0].style.height = '606px';
        ...
        let height = 606; //Altura total del main
